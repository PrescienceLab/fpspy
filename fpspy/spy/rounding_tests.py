...
if(sys.argv[1]=="mpi"):
	...
	print("running baseline test")
        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir rounding_baseline")
        os.system("mv " +output_file_match+" rounding_baseline")
        os.system("mv *fpemon rounding_baseline")

	os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=nearest LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir nearest")
        os.system("mv " +output_file_match+" nearest")
        os.system("mv *fpemon nearest")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=nearest,ftz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir nearest_ftz")
        os.system("mv " +output_file_match+" nearest_ftz")
        os.system("mv *fpemon nearest_ftz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=nearest,daz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir nearest_daz")
        os.system("mv " +output_file_match+" nearest_daz")
        os.system("mv *fpemon nearest_daz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=nearest,daz,ftz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir nearest_daz_ftz")
        os.system("mv " +output_file_match+" nearest_daz_ftz")
        os.system("mv *fpemon nearest_daz_ftz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=zero LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir zero")
        os.system("mv " +output_file_match+" zero")
        os.system("mv *fpemon zero")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=zero,ftz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir zero_ftz")
        os.system("mv " +output_file_match+" zero_ftz")
        os.system("mv *fpemon zero_ftz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=zero,daz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir zero_daz")
        os.system("mv " +output_file_match+" zero_daz")
        os.system("mv *fpemon zero_daz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=zero,daz,ftz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir zero_daz_ftz")
        os.system("mv " +output_file_match+" zero_daz_ftz")
        os.system("mv *fpemon zero_daz_ftz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=positive LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir positive")
        os.system("mv " +output_file_match+" positive")
        os.system("mv *fpemon positive")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=positive,ftz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir positive_ftz")
        os.system("mv " +output_file_match+" positive_ftz")
        os.system("mv *fpemon positive_ftz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=positive,daz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir positive_daz")
        os.system("mv " +output_file_match+" positive_daz")
        os.system("mv *fpemon positive_daz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=positive,daz,ftz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir positive_daz_ftz")
        os.system("mv " +output_file_match+" positive_daz_ftz")
        os.system("mv *fpemon positive_daz_ftz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=negative LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir negative")
        os.system("mv " +output_file_match+" negative")
        os.system("mv *fpemon negative")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=negative,ftz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir negative_ftz")
        os.system("mv " +output_file_match+" negative_ftz")
        os.system("mv *fpemon negative_ftz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=negative,daz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir negative_daz")
        os.system("mv " +output_file_match+" negative_daz")
        os.system("mv *fpemon negative_daz")

        os.system("FPE_MODE=aggregate FPE_AGGRESSIVE=yes FPE_FORCE_ROUNDING=negative,daz,ftz LD_PRELOAD=./fpe_preload.so "+program_command)
        os.system("mkdir negative_daz_ftz")
        os.system("mv " +output_file_match+" negative_daz_ftz")
        os.system("mv *fpemon negative_daz_ftz")
